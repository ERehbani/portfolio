import { c as createComponent, a as createAstro, m as maybeRenderHead, r as renderTemplate } from './astro/server_J9aO5duB.mjs';
import 'piccolore';
import { clsx } from 'clsx';
import { jsx, jsxs } from 'react/jsx-runtime';
import * as React from 'react';
import { useState, useRef } from 'react';
import { XIcon, ChevronLeft, ChevronRight, SquareArrowOutUpRight, HomeIcon, PanelsTopLeftIcon, Cake, MapPin, Mail, FileDown, ChevronDown } from 'lucide-react';
...
import { u as useTheme } from './footer_By48Xjqx.mjs';
...
}, "C:/portfolio/src/components/about.astro", void 0);
        ...
        children: [
          ...
          showCloseButton && /* @__PURE__ */ jsxs(
            DialogPrimitive.Close,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(XIcon, { className: "text-black" }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center w-full", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "w-full overflow-hidden flex justify-center items-center", children: /* @__PURE__ */ jsx("div", { className: "p-4 w-full h-40 flex items-center justify-center mx-auto [@media(max-height:760px)]:max-h-28", children: /* @__PURE__ */ jsxs("div", { className: "text-center max-lg:text-sm", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: "px-3 2xl:px-10 text-gray-800 rounded-md focus:outline-none absolute right-[-6px] top-auto hover:scale-110 transition-transform",
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxs("section", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("h3", { className: "font-semibold text-sm lg:text-base leading-tight", children: exp.title }),
              exp.link.title && /* @__PURE__ */ jsx("a", { href: exp.link.url, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsx(SquareArrowOutUpRight, { className: "w-4 h-4 text-gray-300" }) })
            ] }),
...
function AnimatedStarButton({ text, href = "#" }) {
  return /* @__PURE__ */ jsxs(
    "a",
    {
      href,
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent to-transparent -translate-x-full transition-transform duration-700" }),
        /* @__PURE__ */ jsx("span", { className: "absolute -top-3 left-[10%] text-yellow-300 text-lg animate-twinkle", style: { animationDelay: "0s" }, children: "✦" }),
        /* @__PURE__ */ jsx("span", { className: "absolute -top-3 right-[20%] text-yellow-400 text-base animate-twinkle", style: { animationDelay: "1s" }, children: "✦" }),
        /* @__PURE__ */ jsx("span", { className: "absolute top-[20%] -right-4 text-amber-400 text-lg animate-twinkle", style: { animationDelay: "1.5s" }, children: "✦" }),
        /* @__PURE__ */ jsx("span", { className: "absolute -bottom-3 right-[15%] text-amber-300 text-base animate-twinkle", style: { animationDelay: "2.5s" }, children: "✦" }),
        /* @__PURE__ */ jsx("span", { className: "absolute -bottom-3 left-[15%] text-amber-400 text-sm animate-twinkle z-40", style: { animationDelay: "1.3s" }, children: "✦" }),
        /* @__PURE__ */ jsx("p", { className: "relative z-10 whitespace-nowrap", children: text }),
        /* @__PURE__ */ jsx(SquareArrowOutUpRight, { size: 16, className: "relative z-10 transition-transform" }),
...
const Experience = ({ content }) => {
  return /* @__PURE__ */ jsx("div", { className: "glass-card flex flex-col text-[#3e3e3e] dark:text-white h-96 lg:h-full rounded-2xl overflow-hidden hover:shadow-md hover:shadow-[#3e3e3e] transition-shadow", children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "tab-1", className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 p-5 lg:px-8 pb-0", children: /* @__PURE__ */ jsxs(TabsList, { className: "w-fit bg-transparent justify-start items-center", children: [
      ...
      /* @__PURE__ */ jsx(AnimatedStarButton, { text: content.services_title.title, href: content.services_title.href })
    ] }) }),
...
function ProfileCard({ content }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "glass-card text-white lg:w-full h-fit lg:h-full rounded-2xl bg-black/20 backdrop-blur-sm hover:shadow-md hover:shadow-[#3e3e3e] transition-shadow max-h-screen overflow-y-auto overflow-x-hidden ", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between gap-5 py-5 h-full max-h-[calc(100vh-2rem)] [&>*]:flex-shrink-0 [@media(max-height:700px)]:gap-3 [@media(max-height:700px)]:py-3 [@media(max-height:600px)]:gap-2 [@media(max-height:600px)]:py-2", children: [
    /* @__PURE__ */ jsxs("section", { className: "flex lg:flex-col gap-5 px-2 md:px-5 lg:px-0 [@media(max-height:700px)]:gap-3 [@media(max-height:600px)]:gap-2", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-[#3e3e3e] p-2 rounded-2xl w-fit mx-auto aspect-square object-cover [@media(max-height:700px)]:p-1.5 [@media(max-height:600px)]:p-1", children: /* @__PURE__ */ jsx(
        "img",
        {
          width: 270,
          height: 270,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col mx-auto justify-center gap-5 items-center [@media(max-height:700px)]:gap-3 [@media(max-height:600px)]:gap-2", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold dark:text-white text-[#3e3e3e] [@media(max-height:700px)]:text-xl [@media(max-height:600px)]:text-lg", children: "Elián Rehbani" }),
        /* @__PURE__ */ jsxs("span", { className: "text-xs md:text-sm bg-[#3e3e3e] py-2 px-4 rounded-full flex justify-around items-center text-center w-full lg:w-fit [@media(max-height:700px)]:py-1.5 [@media(max-height:700px)]:px-3 [@media(max-height:600px)]:py-1 [@media(max-height:600px)]:px-2 [@media(max-height:600px)]:text-xs", children: [
          /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-green-600 shadow-md shadow-green-700 animate-ping mr-2 [@media(max-height:600px)]:w-1.5 [@media(max-height:600px)]:h-1.5" }),
          content.openToWork
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "grid grid-cols-2 lg:flex lg:flex-col gap-2 items-center px-2  lg:px-2 xl:px-5 [@media(max-height:700px)]:gap-1.5 [@media(max-height:600px)]:gap-1", children: [
      /* @__PURE__ */ jsxs("span", { className: "text-xs text-[#3e3e3e] dark:text-white lg:text-sm border border-gray-600 px-4 py-2 gap-2 rounded-full flex items-center justify-center [@media(max-height:700px)]:px-3 [@media(max-height:700px)]:py-1.5 [@media(max-height:600px)]:px-2 [@media(max-height:600px)]:py-1 [@media(max-height:600px)]:text-xs [@media(max-height:600px)]:gap-1", children: [
        /* @__PURE__ */ jsx(Cake, { className: "w-5 text-[#818181] [@media(max-height:600px)]:w-4" }),
        content.birthday
      ] }),
      /* @__PURE__ */ jsxs("span", { className: "text-xs text-[#3e3e3e] dark:text-white lg:text-sm border border-gray-600 px-4 py-2 gap-2 rounded-full flex items-center justify-center [@media(max-height:700px)]:px-3 [@media(max-height:700px)]:py-1.5 [@media(max-height:600px)]:px-2 [@media(max-height:600px)]:py-1 [@media(max-height:600px)]:text-xs [@media(max-height:600px)]:gap-1", children: [
        /* @__PURE__ */ jsx(MapPin, { className: "w-5 text-[#818181] [@media(max-height:600px)]:w-4" }),
        "Mar del Plata",
        /* @__PURE__ */ jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 col-span-2 [@media(max-height:600px)]:gap-1 w-full max-[1130px]:flex-col min-[1130px]:flex-row", children: [
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Mail, { className: "w-5 text-white dark:text-[#3e3e3e] transition-all [@media(max-height:600px)]:w-4" }),
              /* @__PURE__ */ jsx("span", { className: "lg:hidden text-white dark:text-[#3e3e3e]", children: content.sendEmail })
            ]
          }
        ),
        /* @__PURE__ */ jsx("span", { className: "hidden lg:block text-sm text-center text-[#3e3e3e] dark:text-white [@media(max-height:600px)]:text-xs", children: "elianrhbn@gmail.com" })
      ] }),
      /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { className: "text-sm text-white lg:mt-10 flex items-center border-2 border-[#383838] gap-2 justify-center py-6 w-full rounded-md bg-[#3e3e3e] hover:bg-[#2A2A2A] transition-colors col-span-2 [@media(max-height:700px)]:lg:mt-6 [@media(max-height:700px)]:py-4 [@media(max-height:600px)]:lg:mt-3 [@media(max-height:600px)]:py-3 [@media(max-height:600px)]:text-xs", children: [
          /* @__PURE__ */ jsx(FileDown, { className: "w-5 text-white [@media(max-height:600px)]:w-4" }),
          content.downloadCV,
          /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4 ml-1 [@media(max-height:600px)]:w-3 [@media(max-height:600px)]:h-3" })
        ] }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "w-[90%] mx-auto h-[1px] bg-[#393939] [@media(max-height:600px)]:w-[85%]" }),
    /* @__PURE__ */ jsxs("section", { className: "w-[80%] mx-auto flex justify-around items-center h-fit [@media(max-height:600px)]:w-[75%]", children: [
      /* @__PURE__ */ jsx(
        "a",
        {
...
export { $$About as $, Certifications as C, Experience as E, InfiniteTextCarousel as I, ProfileCard as P };
