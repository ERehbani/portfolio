...
export default function AnimatedStarButton({ text, href = '#' }: AnimatedStarButtonProps) {
  return (
    <a
      href={href}
      className="relative inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium text-sm transition-all duration-300 dark:hover:text-white hover:text-black"
    >
      {/* Efecto de brillo */}
      <div className="absolute inset-0  from-transparent to-transparent -translate-x-full transition-transform duration-700" />
