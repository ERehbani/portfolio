...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="p-2 w-fit rounded-lg border border-[#3e3e3e] dark:bg-[#3e3e3e] text-[#3e3e3e] dark:text-gray-200 dark:hover:bg-[#1e1e1e] hover:bg-[#1e1e1e] hover:[&_svg]:text-white transition-colors duration-200 absolute top-1 right-1  lg:left-1"
