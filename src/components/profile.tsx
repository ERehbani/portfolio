...
export default function ProfileCard({ content }: { content: ContentProfile }) {
  ...
  return (
    <div className="glass-card  text-white lg:w-full h-fit lg:h-full rounded-2xl bg-black/20 backdrop-blur-sm hover:shadow-md hover:shadow-[#3e3e3e] transition-shadow">
      <div className="flex flex-col justify-between gap-5 py-5 h-full">
        <section className="flex lg:flex-col gap-5 px-2 md:px-5 lg:px-0">
          ...
          <div className="flex flex-col mx-auto justify-center gap-5 items-center">
            <h1 className="text-2xl font-semibold dark:text-white text-[#3e3e3e]">
              Elián Rehbani
            </h1>
        ...
        <section className="grid grid-cols-2 lg:flex lg:flex-col gap-2 items-center px-2 lg:px-5">
          ...
          <div className="flex items-center gap-2 col-span-2">
            ...
            >
              ...
              <span className="lg:hidden text-white dark:text-[#3e3e3e]">
                {content.sendEmail}
              </span>
            </a>
            <span className="hidden lg:block text-sm text-[#3e3e3e] dark:text-white">
              elianrhbn@gmail.com
            </span>
          </div>
        ...
        <section className="w-[80%] mx-auto flex justify-around items-center h-fit">
          <a
